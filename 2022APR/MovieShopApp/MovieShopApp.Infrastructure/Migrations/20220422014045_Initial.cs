        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TmdbUrl = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true),
                    ProfilePath = table.Column<string>(type: "varchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRole", x => new { x.UsersId, x.RoleId });
                    table.ForeignKey(
